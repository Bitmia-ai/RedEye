...
name: init
description: |
  Initialize RedEye in the current project. Quick-start (default, ~2 min)
  asks 4 questions, scaffolds all control files. Full setup (--full) adds personas,
  model config, and wiki sync.
---
